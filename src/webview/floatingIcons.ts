/*
 * Icons for the selection toolbar and the link popover: single-color SVGs with
 * Lucide geometry, drawn in `currentColor` so they take the button's themed color.
 */
